...
//                            break;
                        case "Date/Time Original":
                            ...
                            break;
                        case "GPS Latitude":
                            coordinate.put("longitude", PointUtil.pointToLatlong(desc));
                            log.info("照片纬度 : " + PointUtil.pointToLatlong(desc));
//                            System.err.println("纬度(度分秒格式) : " + PointUtil.pointToLatlong(desc));
                            break;
                        case "GPS Longitude":
                            coordinate.put("latitude", PointUtil.pointToLatlong(desc));
                            log.info("照片经度: " + PointUtil.pointToLatlong(desc));
